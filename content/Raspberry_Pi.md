...
`systemd-unit` baut, mit welchem sich die Bridge start lässt.
...
##########################################################
# Because of the following two programs wifi and ethernet will share the same subnet
#
...
Normalerweise sollte das Script auch unter
`~/.scripts/raspberrypi/bridge.sh` liegen.
